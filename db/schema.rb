...
ActiveRecord::Schema.define(version: 20170914152855) do
  ...
  create_table "machines_snacks", force: :cascade do |t|
    t.bigint "machine_id"
    t.bigint "snack_id"
  ...
  add_foreign_key "machines_snacks", "machines"
  add_foreign_key "machines_snacks", "snacks"
end
